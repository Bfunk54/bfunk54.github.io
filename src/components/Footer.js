...
function Footer() {
  return (
    <footer className="footer">
        ...
        <a style= {{padding: '16px'}} href="https://www.linkedin.com/in/benjamin-fein-5a73b2242/" target="_blank" rel="noreferrer">
            <i style={{fontSize: '40px'}} className="bi bi-linkedin"><span style={{fontSize: '10px', padding: '4px'}}>linkedin</span></i>
        </a>

        <a style= {{padding: '16px'}} href="https://twitter.com/ben_fein" target="_blank" rel="noreferrer">
